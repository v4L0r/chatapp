    ...
    <div className="h-full w-full bg-gray-50 overflow-y-auto">
      <div className="max-w-5xl mx-auto px-6 py-12 md:py-20">
        ...
        <div className="text-center mb-16">
          ...
          >
            Welcome to <span className="text-emerald-600">Vox</span>
          </motion.h1>
          <motion.p 
            initial={{ opacity: 0 }}
            animate={{ opacity: 1 }}
          ...
          >
            More than just a cheap ass Whatsapp/Telegram clone. We do not value your privacy and all your chats and data are available unencrypted on the backend.
          </motion.p>
        </div>
        ...
        >
          ...
          <Link to="/login" className="group">
            ...
            >
              ...
              <p className="text-gray-500 mb-6 flex-1">
                Do you know that all these tailwind css are Generated by GEMINI PRO 3?
              </p>
          ...
          <Link to="/register" className="group">
            ...
            >
              ...
              <p className="text-gray-500 mb-6 flex-1">
                Registration is free and no verifications are required. Go look up Sybil Attack (SYBAU!!!)
              </p>
          ...
          <Link to="/admin" className="group">
            ...
            >
              ...
              <p className="text-gray-500 mb-6 flex-1">
                This really isn't an entry point because no admin routes even exist at this point. But you can try anyway.
              </p>
